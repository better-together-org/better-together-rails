...
ActiveRecord::Schema[7.1].define(version: 2025_08_11_150711) do
  ...
  create_table "stages", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["venue_id", "primary_flag"], name: "index_stages_on_venue_id_and_primary", unique: true, where: "(primary_flag IS TRUE)"
  ...
  create_table "venue_buildings", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["venue_id", "primary_flag"], name: "index_venue_buildings_on_venue_id_and_primary", unique: true, where: "(primary_flag IS TRUE)"
  ...
  create_table "venue_images", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["venue_id", "primary_flag"], name: "index_venue_images_on_venue_id_and_primary", unique: true, where: "(primary_flag IS TRUE)"
  ...
  create_table "venue_invitation_venues", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["venue_id", "venue_invitation_id"], name: "idx_on_venue_id_venue_invitation_id_2f129feec6"
  ...
  create_table "venue_offers", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["venue_id", "primary_flag"], name: "index_venue_offers_on_venue_id_and_primary", unique: true, where: "(primary_flag IS TRUE)"
  ...
  create_table "venues", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["privacy"], name: "by_venues_privacy"
  end
